            ...
            <section
                  ...
                  />
                    ...
                    <p className="text-lg max-w-2xl">
                        Sigue estos pasos para instalar la extensión de CiberKids en tu navegador y comenzar a disfrutar de una experiencia más segura y divertida en línea.
                    </p>
                    <ul>
                      <li>Con la potencia de Gemini, CiberKids Extension asegura el análisis de una página web y advierte a los usuarios si tiene contenido apropiado o no para niños</li>
                      <li>Basta con darle un clic a la extensión para que CiberKids Extension actue</li>
                    </ul>
                    </section>
