  ...
  return (
    <div className="relative w-full mx-auto rounded-3xl overflow-hidden shadow-xl" id="hero">
      <div className="relative h-64 sm:h-80 md:h-[32rem] w-full">
        ...
        <div
          className="absolute left-0 top-0 h-full w-[80%] sm:w-[70%] md:w-[65%] bg-[#A3BED6] dark:bg-[#111827] flex flex-col justify-center p-4 sm:p-6 md:p-10 z-10 rounded-2xl shadow-lg"
        ...
        >
          <div className="ml-4 sm:ml-8 md:ml-20 max-w-md">
            ...
            <a
              ...
              className="mt-4 sm:mt-6 inline-block px-6 sm:px-10 py-2 sm:py-3 text-sm sm:text-base font-semibold uppercase rounded-lg shadow-lg transition-all duration-500 bg-gradient-to-r from-[#314755] via-[#26a0da] to-[#314755] bg-[length:200%_auto] hover:bg-right dark:from-[#614385] dark:via-[#516395] dark:to-[#614385] border-2 border-white/50 dark:border-white/30"
            >
              Ver producto
            </a>
          </div>
      ...
      <div className="absolute z-30 flex -translate-x-1/2 space-x-3 bottom-4 sm:bottom-6 left-1/2">
        {slides.map((_, idx) => (
          <button
            key={idx}
            type="button"
            className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded-full ${active === idx ? "bg-blue-600" : "bg-white/60 backdrop-blur"}`}
